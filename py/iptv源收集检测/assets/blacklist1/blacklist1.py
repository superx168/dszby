...
if __name__ == "__main__":
    ...
    input_file2 = os.path.join(current_dir, 'py/iptv源收集检测/assets/blacklist1/blacklist_auto.txt')  # 输入文件路径2 
    success_file = os.path.join(current_dir, 'py/iptv源收集检测/assets/blacklist1/whitelist_auto.txt')  # 成功清单文件路径
    success_file_tv = os.path.join(current_dir, 'py/iptv源收集检测/assets/blacklist1/whitelist_auto_tv.txt')  # 成功清单文件路径（另存一份直接引用源）
    blacklist_file = os.path.join(current_dir, 'py/iptv源收集检测/assets/blacklist1/blacklist_auto.txt')  # 黑名单文件路径
    ...
    history_success_file = f'/home/runner/work/dszby/dszby/py/iptv源收集检测/history/blacklist/{timenow}_whitelist_auto.txt'
    history_blacklist_file = f'/home/runner/work/dszby/dszby/py/iptv源收集检测/history/blacklist/{timenow}_blacklist_auto.txt'
