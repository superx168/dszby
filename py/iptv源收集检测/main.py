...
blacklist_auto=read_blacklist_from_txt('iptv源收集检测/assets/blacklist1/blacklist_auto.txt') 
blacklist_manual=read_blacklist_from_txt('iptv源收集检测/assets/blacklist1/blacklist_manual.txt') 
