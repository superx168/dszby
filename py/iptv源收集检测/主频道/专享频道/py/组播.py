...
def updateChannelUrlsM3U(channels, template_channels):
   ...
   # for group in config.announcements:
    ...
    with open("py/iptv源收集检测/主频道/专享频道/py/组播/live.m3u", "w", encoding="utf-8") as f_m3u:
        f_m3u.write(f"""#EXTM3U x-tvg-url={",".join(f'"{epg_url}"' for epg_url in config.epg_urls)}\n""")

        with open("py/iptv源收集检测/主频道/专享频道/♪组播频道.txt", "w", encoding="utf-8") as f_txt:
           # for group in config.announcements:
...
if __name__ == "__main__":
    template_file = "py/iptv源收集检测/主频道/专享频道/py/组播/demo.txt"
