...
def multicast_province(config_file):
    ...
    template_file = os.path.join('template', f"py/iptv源收集检测/主频道/专享频道/py/组播/template_{province}.txt")
    ...
    with open(f"py/iptv源收集检测/主频道/专享频道/py/组播/ip/{province}_ip.txt", 'r', encoding='utf-8') as f:    
        for line_num, line in enumerate(f, 1):
            ip = line.strip()
            with open(template_file, 'r', encoding='utf-8') as t, open(f"py/iptv源收集检测/主频道/专享频道/py/组播/扫描/组播_{province}.txt", 'a', encoding='utf-8') as output:
