...
check_and_write_file('2.txt',  'e.txt',  keywords="港澳台频道, EYETV戏剧,TVBS欢乐,TVBS新闻,爱尔达影剧,八大第一,八大戏剧,八大综合,东森洋片,东森幼幼,东森综合,公视,民视第一,民视台湾台,
                     三立戏剧,三立综合,无线新闻,中视,中视新闻,中天亚洲,中天娱乐,Now星影,TVB星河,翡翠台泰国,靖天电影,龙华电影,美亚电影,TVB翡翠台（备用）,TVB明珠,TVB千禧经典,TVB无线新闻,
                     TVB星河,TVB亚洲武侠,TVBJ1,TVBPlus,翡翠台,翡翠台版TVBJ1,凤凰香港备用1,凤凰中文,凤凰资讯,无线翡翠,")
###############################################################################################################################################################################################################################
##############################################################对生成的文件进行合并
file_contents = []
